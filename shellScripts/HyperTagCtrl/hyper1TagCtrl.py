#---------------------------------------------------------------------------------------------------------------	#
# This file id designed for kvm-host1 pox controller							     	#
# If you are using this for any other hypervisor controller, manually change trunk port 	#
# 	by checking 'patchintfs' from 'sudo ovs-ofctl show ovsbr0'						#
#---------------------------------------------------------------------------------------------------------------	#
...
class TagSwitch (object):
  ...
  def _handle_PacketIn (self, event):
    trunk = 4		# Change trunk port by manually checking ovs-ofctl 
    macToVlanFile = 'macToVlan1.txt'
    packet = event.parsed
