#---------------------------------------------------------------------------------------------------------------	#
# This file id designed for kvm-host3 pox controller							     	#
...
class TagSwitch (object):
  ...
  def _handle_PacketIn (self, event):
    trunk = 2		# Change trunk port by manually checking ovs-ofctl 
    macToVlanFile = 'macToVlan3.txt'
    packet = event.parsed
